...
lookup_statement = session.prepare 
rows = session.execute( 'select speed from freeway_loopdata_OneHour where detectorid = 1346 and starttime >= \'2011-09-15\' and starttime < \'2011-09-15 00:10:00\' ');
